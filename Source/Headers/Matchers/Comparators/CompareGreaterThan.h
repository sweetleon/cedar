...
#pragma mark NSDecimal
    ...
    inline bool compare_greater_than(const NSDecimal & actualValue, NSDecimalNumber * const expectedValue) {
        NSDecimal expectedDecimalValue = [expectedValue decimalValue];
        return NSOrderedDescending == NSDecimalCompare(&actualValue, &expectedDecimalValue);
    }
    ...
    inline bool compare_greater_than(NSDecimalNumber * const actualValue, const NSDecimal & expectedValue) {
        NSDecimal actualDecimalValue = [actualValue decimalValue];
        return NSOrderedDescending == NSDecimalCompare(&actualDecimalValue, &expectedValue);
    }
